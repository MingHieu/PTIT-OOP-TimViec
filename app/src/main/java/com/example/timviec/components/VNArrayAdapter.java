...
public class VNArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     *                           instantiating views.
     */
    public VNArrayAdapter(Context context, int textViewResourceId) {
     ...
     */
    public VNArrayAdapter(Context context, int resource, int textViewResourceId) {
     ...
     */
    public VNArrayAdapter(Context context, int textViewResourceId, T[] objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public VNArrayAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public VNArrayAdapter(Context context, int textViewResourceId, List<T> objects) {
    ...
    private class HRArrayFilter extends Filter {
        ...
        private String toNoPalatals(String s) {
